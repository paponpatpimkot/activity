...
if (!isset($_SESSION['user_id']) || $_SESSION['role_id'] != 3) { // ตรวจสอบว่าเป็น Admin (role_id = 1)
...
<body class="g-sidenav-show bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-2">
      ...
      $pages_directory = ''; // กำหนด Path ไปยัง Folder ที่เก็บไฟล์เนื้อหา เช่น 'pages/' หรือ '' ถ้าอยู่ Directory เดียวกัน
      $file_to_include = '';
      ...
      switch (strtolower($page)) { // ใช้ strtolower เพื่อไม่สนตัวพิมพ์เล็ก/ใหญ่
        case 'dashboard':
          ...
          $file_to_include = $pages_directory . 'dashboard.php'; // ไฟล์เนื้อหา Dashboard
          break;
        case 'booking_history':
          $file_to_include = $pages_directory . 'booking_history.php';
          break;
        case 'student_activities':
          $file_to_include = $pages_directory . 'student_activity.php';
          break;
        case 'attendance_history':
          $file_to_include = $pages_directory . 'attendance_history.php';
          break;
        case 'edit_profile':
            $file_to_include = '../actions/edit_profile.php';
            break;
        default:
